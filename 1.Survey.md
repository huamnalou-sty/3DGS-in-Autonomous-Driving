...
* 🔗 **Link**：\[[arXiv:2510.23988](https://arxiv.org/abs/2510.23988)]
* 📖 **Introduction**：This is the first survey dedicated to multi-robot collaborative SLAM using 3D Gaussian Splatting (CoGS-SLAM). It proposes a clear taxonomy (centralized vs. distributed), deeply analyzes key technical challenges including multi-agent consistency and alignment, communication efficiency, Gaussian fusion, pose optimization, and real-time scalability, while highlighting applications in autonomous driving, digital twins, and exploration. It also summarizes datasets/metrics and identifies critical future directions such as lifelong mapping, semantic association, and Sim2Real transfer.

**\[12]. Compression in 3D Gaussian Splatting: A Survey of Methods, Trends, and Future Directions**

* 🧑‍🎓 **Author**：Muhammad Salman Ali, Chaoning Zhang, Marco Cagnazzo, Giuseppe Valenzise, Enzo Tartaglione, Sung-Ho Bae
* 🔗 **Link**：\[[arXiv:2502.19457](https://arxiv.org/abs/2502.19457)]
* 📖 **Introduction**：This survey systematically reviews the critical challenge of memory/storage explosion in 3DGS, provides a structured taxonomy of compression techniques, compares them from a topological perspective (fidelity, ratio, speed), and explores how lessons from NeRF compression can inspire the next generation of compact, deployable 3DGS models suitable for resource-constrained platforms including autonomous vehicles and robots.

**\[11]. 3D Gaussian Splatting in Robotics: A Survey**

* 🧑‍🎓 **Author**：Siting Zhu, Guangming Wang, Xin Kong, Dezhi Kong, Hesheng Wang
* 🔗 **Link**：\[[arXiv:2410.12262](https://arxiv.org/abs/2410.12262)]
* 📖 **Introduction**：This is the first comprehensive survey focused on 3DGS specifically in robotics. It categorizes works into scene understanding (reconstruction, mapping, SLAM) and interaction tasks (manipulation, navigation, planning), while separately reviewing technical advancements that improve 3DGS adaptability, efficiency, and robustness for real robotic systems. Includes detailed dataset/metric summary, performance comparisons, and an excellent discussion of remaining challenges and future directions in the field.
